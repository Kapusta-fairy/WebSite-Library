...
var fontS =10;
var interval =10;
var vi_css = "http://127.0.0.1:8000/static/plugin/visually_impaired/vi.css";
var info_mp3 = "http://127.0.0.1:8000/static/plugin/visually_impaired/info.mp3";
var eye_png = "http://127.0.0.1:8000/static/plugin/visually_impaired/eye.png";
...
if (spec == 'y')
{
  ...
  inputTag.setAttribute("style", "position:fixed; z-index:9999; cursor: pointer; outline: none; bottom:20px; font-size:20px; right:20px; margin: 5px;padding:5px; border: none; font-weight:bold; background: url('http://127.0.0.1:8000/static/plugin/visually_impaired/eye.png') no-repeat; background-size:cover; width:100px; height:73px; " );
 inputTag.value="";
 // inputTag.value=" ������ ��� ������������ ";
}
